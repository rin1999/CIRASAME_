...
#        print(cirasame_number, yaml_path, ip_address, bias[1], threshold[1])
    ...
    return ip_addresses, yaml_pathes, InputDAC_yml_filenames, Register_yml_filenames, DiscriMask_yml_filenames, biases, thresholds
...
#    with open('RegisterValue.yml', 'r') as file:
    ...
    with open(str(yaml_file), 'r') as file:
        ...
        # Modifying data
        data['CITIROC1']['DAC2 code'] = thresholds[1]
        data['CITIROC2']['DAC2 code'] = thresholds[2]
        data['CITIROC3']['DAC2 code'] = thresholds[3]
        data['CITIROC4']['DAC2 code'] = thresholds[4]
...
def main():
    ...
    if args.mode == "remote":
        ...
        ip_addresses, yaml_pathes, InputDAC_yml_filenames, Register_yml_filenames, DiscriMask_yml_filenames, biases, thresholds = access_local_excel(args.file_path_or_id)

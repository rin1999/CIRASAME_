...
for file_path in file_list:
    ...
    if df.iat[read_row, read_col+1] == 0:
        ...
        hits.append(df.iat[read_row, read_col+1]/t)
...
#print(df)
dac_val
df = pd.DataFrame({'DAC_value':dac_val,
                    'ch{}'.format(args.channel):hits})
df = df.sort_values('DAC_value')
df.to_csv('testdata.dat', sep=' ', header=None, index=None)

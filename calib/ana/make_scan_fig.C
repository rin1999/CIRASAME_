...
void make_scan_fig(TString fileName) {
...
//   gMinuit->SetPrintLevel(0);
   ...
   outputOutFileName = "scan_chan_" + matchedPart + ".out";  // channel-wise output
   outputOutFileName2 = "scan_ana_asic_" + matchedPart + ".out"; // asic-wise output
   outputOutFileName3 = "scan_ana_crsm_" + matchedPart + ".out"; // cirasame-wise output
   outputPDFFileName = outputPDFDir + "/scan_" + matchedPart + ".pdf";
   ...
   h_gain->GetXaxis()->SetLabelSize(0.05);
   h_gain->GetYaxis()->SetLabelSize(0.05);
   g_idgain->GetXaxis()->SetTitle("Global Channel");
   g_idgain->GetYaxis()->SetTitle("Gain (DAC)");
   g_idgain->GetXaxis()->SetLabelSize(0.05);
   g_idgain->GetYaxis()->SetLabelSize(0.05);

...
void threscan_ana_2(TString fileName) {
...
//   gMinuit->SetPrintLevel(0);
   ...
   outputOutFileName = "test_chan_" + matchedPart + ".out";  // channel-wise output
   outputOutFileName2 = "test_asic_" + matchedPart + ".out"; // asic-wise output
   outputOutFileName3 = "test_crsm_" + matchedPart + ".out"; // cirasame-wise output
   outputPDFFileName = outputPDFDir + "/test_" + matchedPart + ".pdf";
   ...
   TH1F* h_gain = new TH1F("h_gain", "Gain distribution", 200, 0, 400);

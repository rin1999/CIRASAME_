...
#        print(type(thresholds[1]))
        ...
        # Modifying data
        data['CITIROC1']['DAC2 code'] = int(thresholds[1] + 15)
        data['CITIROC2']['DAC2 code'] = int(thresholds[2] + 15)
        data['CITIROC3']['DAC2 code'] = int(thresholds[3] + 15)
        data['CITIROC4']['DAC2 code'] = int(thresholds[4] + 15)
